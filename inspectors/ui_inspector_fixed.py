...
class 完璧なUIInspectionSystem:
    def __init__(self):
        self.window_title = "完璧な UI Inspection System"
        self.camera = None
        self.model = None
        self.class_names = []
    ...
    def load_model(self):
        ...
        try:
            ...
            if os.path.exists(model_path):
                print(f"実画像データで学習されたAIモデルを読み込みまム: {model_path}")
    ...
    def run(self):
        ...
        cv2.setWindowプロperty(self.window_title, cv2.WND_PROP_TOPMOST, 0)
        ...
        while True:
            ...
            cv2.putText(display_frame, f"Model: 完璧な UI | Camera: {self.selected_camera_id}", 
            ...
            if cv2.getWindowプロperty(self.window_title, cv2.WND_PROP_VISIBLE) < 1:
                break
