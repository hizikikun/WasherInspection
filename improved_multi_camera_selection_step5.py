...
class ImprovedMultiCameraSelectionSystem:
    def __init__(self):
        ...
        # Prediction settings - improved stability
        self.prediction_history = deque(maxlen=15)  # Increased buffer
        self.stability_threshold = 0.15  # Increased threshold
        self.min_stable_count = 5  # Increased stable count
        self.current_prediction = "good"
        self.prediction_confidence = 0.0
        self.last_prediction_time = 0
        self.prediction_interval = 0.2  # Increased interval
    ...
    def run(self):
        ...
        while True:
            ...
            y_offset += 25
            camera_info = f"Model: IMPROVED | Camera: {self.camera_id} | {w}x{h}"
            if self.camera_id == 2:
                camera_info += " (Full HD)"
            cv2.putText(frame, camera_info, (hud_x + 20, y_offset), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
