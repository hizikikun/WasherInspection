...
# -*- coding: utf-8 -*-
"""
4-Class Ultra-High Accuracy Deep Learning with Advanced Spatial Modeling
...
class FourClassUltraHighAccuracyWasherInspector:
    ...
    def load_and_prepare_data(self):
        """Load data with comprehensive spatial modeling for 4 classes"""
        print("Loading data with ultra-advanced spatial modeling for 4 classes...")
        ...
        for i, model_config in enumerate(ensemble_models):
            ...
            callbacks_list = [
                ...
                callbacks.ModelCheckpoint(
                    f'best_4class_{model_name.lower()}_model.h5',
                    monitor='val_accuracy',
                    save_best_only=True,
                    verbose=1
                ),
                callbacks.CSVLogger(f'training_log_4class_{model_name.lower()}.csv')
            ]
    ...
    def save_ensemble_models(self):
        ...
        for i, model in enumerate(self.models):
            model_name = f"ensemble_4class_model_{i+1}.h5"
            model.save(model_name)
            print(f"Saved {model_name}")
        
        # Save ensemble info
        ensemble_info = {
            'model_name': '4-Class Ultra-High Accuracy Ensemble Washer Inspector',
            ...
            'description': 'Ensemble of EfficientNet models for 4-class defect detection with comprehensive spatial modeling'
        }
        
        with open('ensemble_4class_info.json', 'w') as f:
            json.dump(ensemble_info, f, indent=2)
        
        print("Ensemble information saved to ensemble_4class_info.json")

def main():
    """Main training function for 4 classes"""
    print("=== 4-Class Ultra-High Accuracy Deep Learning with Advanced Spatial Modeling ===")
    
    # Initialize inspector
    inspector = FourClassUltraHighAccuracyWasherInspector()
    ...
    try:
        ...
        print("All 4-class ensemble models saved!")
